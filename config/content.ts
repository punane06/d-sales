export const content = {
    ...
    bonuses: [
      {
        ...
        description: 'Tu planificador semanal visual. Te digo exactamente qué comer de lunes a domingo y qué\ncomprar en el súper, para que no tengas que pensar ni estresarte nunca más en la cocina.',
        value: '$17.95',
        icon: '🧠',
      },
      {
        ...
        description: '20 aderezos, mayonesas y patés que revivirán tus comidas sin añadir un gramo de azúcar. ¡Despídete para siempre de la comida seca y aburrida!',
        value: '$14.95',
        icon: '🥗',
      },
      {
        ...
        description: '15 batidos frutales y tés antiestrés listos en 3 minutos. El "escudo protector" perfecto para calmar tu sistema nervioso en la noche y eliminar los antojos dulces.',
        value: '$14.95',
        icon: '🥤',
      },
      {
        ...
        description: 'Descubre 12 bases caseras y súper económicas para que puedas hornear tus propios panes, tortillas y arepas sin provocar picos de insulina.',
        value: '$9.95',
        icon: '🍕',
      },
    ],
  ...
  footer: {
    copyright:
      "Copyright 2026. © 2026 'El Plato Seguro' — Todos los derechos reservados.",
    instagramUrl: 'https://www.instagram.com/elplatoseguro?utm_source=qr&igsh=MTJ5bzhxc3F2a216dw==',
    facebookUrl: 'https://www.facebook.com/share/19yqaBHVRc/',
    youtubeUrl: 'https://youtube.com/@elplatoseguro?si=xpUBjrd9nBsTcfGL',
    tiktokUrl: 'https://www.tiktok.com/@elplatoseguro?_r=1&_t=ZN-95EiDZ5lAc2',
    instagramLabel: 'Instagram de El Plato Seguro',
    facebookLabel: 'Facebook de El Plato Seguro',
    youtubeLabel: 'YouTube de El Plato Seguro',
    tiktokLabel: 'TikTok de El Plato Seguro',
  },
  analytics: {
    metaPixelId: process.env.NEXT_PUBLIC_META_PIXEL_ID ?? 'xxxxxxxxxx',
    sectionNames: {
      hero: 'hero',
